...
def fetch_earn_tokens() -> pd.DataFrame:
    ...
    for item in data:
        ...
        deposit_apy = _safe_num(
            _pick_first(item, "totalRate", "supplyRate", "apy", "supplyApy")
        )
        base_supply_apy = _safe_num(_pick_first(item, "supplyRate", "apy", "supplyApy"))
        rewards_rate = _safe_num(_pick_first(item, "rewardsRate"))
